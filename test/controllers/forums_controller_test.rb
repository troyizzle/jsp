...
class ForumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum" do
    assert_difference("Forum.count") do
      post forums_url, params: { forum: { category_id: @forum.category_id, title: @forum.title } }
    end
  ...
  test "should update forum" do
    patch forum_url(@forum), params: { forum: { category_id: @forum.category_id, title: @forum.title } }
